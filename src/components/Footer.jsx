...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      href: 'https://facebook.com/lunavenails'
    },
    {
      name: 'WhatsApp',
      icon: (
      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 py-12">
          ...
          >
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              ...
              Experience luxury, creativity, and exceptional care.
            </p>
            <div className="flex gap-3">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  className="w-10 h-10 bg-baby-pink/20 hover:bg-baby-pink text-baby-pink hover:text-white rounded-full flex items-center justify-center transition-all duration-300"
              ...
              {footerLinks.map((link) => (
                <li key={link.name}>
                  <button
                    ...
                    className="text-gray-300 hover:text-baby-pink transition-colors duration-300 text-sm"
                  >
                    {link.name}
                  </button>
                </li>
          ...
          >
            ...
            <div className="space-y-3 text-sm text-gray-300">
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 text-baby-pink" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>info@lunavenails.com</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 text-baby-pink" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <motion.button
              onClick={scrollToWhatsApp}
              className="btn-primary bg-baby-pink hover:bg-pink-400 text-white text-sm mt-4"
        ...
        <div className="border-t border-gray-700 py-6 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            >
              <a href="#" className="hover:text-baby-pink transition-colors duration-300">
                Privacy Policy
              </a>
              <a href="#" className="hover:text-baby-pink transition-colors duration-300">
                Terms of Service
